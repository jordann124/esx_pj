...
Config.EnableESXIdentity          = true -- somente ligue isto se você estiver a usar o esx_identity
...
Config.PjStations = {
  ...
  PJ = {
    ...
    AuthorizedVehicles = {
	  {name = 'fbi2', label = 'Suv PJ'},
	  {name = 'fbi', label = 'Buffalo PJ'}, 
      {name = 'riot', label = 'Riot GOE'},
      {name = 'schafter5', label = 'Limousine'},	  
    },
	
	AuthorizedVehicles1 = {
	  {name = 'frogger2' , label = 'Heli'}
	},
