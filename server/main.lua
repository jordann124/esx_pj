...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'pj', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'pj', _U('alert_sheriff'), true, true)
TriggerEvent('esx_society:registerSociety', 'pj', 'pj', 'society_pj', 'society_pj', 'society_pj', {type = 'public'})

RegisterServerEvent('esx_pj:giveWeapon')
AddEventHandler('esx_pj:giveWeapon', function(weapon, ammo)
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.addWeapon(weapon, ammo)
end)

RegisterServerEvent('esx_pj:confiscatePlayerItem')
AddEventHandler('esx_pj:confiscatePlayerItem', function(target, itemType, itemName, amount)
...
RegisterServerEvent('esx_pj:handcuff')
AddEventHandler('esx_pj:handcuff', function(target)
  TriggerClientEvent('esx_pj:handcuff', target)
end)

RegisterServerEvent('esx_pj:drag')
AddEventHandler('esx_pj:drag', function(target)
  local _source = source
  TriggerClientEvent('esx_pj:drag', target, _source)
end)

RegisterServerEvent('esx_pj:putInVehicle')
AddEventHandler('esx_pj:putInVehicle', function(target)
  TriggerClientEvent('esx_pj:putInVehicle', target)
end)

RegisterServerEvent('esx_pj:OutVehicle')
AddEventHandler('esx_pj:OutVehicle', function(target)
    TriggerClientEvent('esx_pj:OutVehicle', target)
end)

RegisterServerEvent('esx_pj:getStockItem')
AddEventHandler('esx_pj:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_pj', function(inventory)
...
RegisterServerEvent('esx_pj:putStockItems')
AddEventHandler('esx_pj:putStockItems', function(itemName, count)
...
ESX.RegisterServerCallback('esx_pj:getOtherPlayerData', function(source, cb, target)
...
ESX.RegisterServerCallback('esx_pj:getFineList', function(source, cb, category)
...
ESX.RegisterServerCallback('esx_pj:getVehicleInfos', function(source, cb, plate)
...
ESX.RegisterServerCallback('esx_pj:getArmoryWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_pj', function(store)
...
ESX.RegisterServerCallback('esx_pj:addArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_pj:removeArmoryWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_pj:buy', function(source, cb, amount)

  TriggerEvent('esx_addonaccount:getSharedAccount', 'society_pj', function(account)
...
ESX.RegisterServerCallback('esx_pj:getStockItems', function(source, cb)
...
ESX.RegisterServerCallback('esx_pj:getPlayerInventory', function(source, cb)
...
RegisterServerEvent('esx_pj:codedmv') --Lui retire son Code coter Bdd
AddEventHandler('esx_pj:codedmv', function(playerId)
...
RegisterServerEvent('esx_pj:codedrive') --Lui retire son Code coter Bdd
AddEventHandler('esx_pj:codedrive', function(playerId)
local xPlayer = ESX.GetPlayerFromId(playerId) --Variable playerId sert a trouver Id du joueur proche.
local sourceXPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_pj:codedrivebike') --Lui retire son Code coter Bdd
AddEventHandler('esx_pj:codedrivebike', function(playerId)
local xPlayer = ESX.GetPlayerFromId(playerId) --Variable playerId sert a trouver Id du joueur proche.
local sourceXPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_pj:codedrivetruck') --Lui retire son Code coter Bdd
AddEventHandler('esx_pj:codedrivetruck', function(playerId)
local xPlayer = ESX.GetPlayerFromId(playerId) --Variable playerId sert a trouver Id du joueur proche.
local sourceXPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent('esx_pj:weaponlicense') --Lui retire son Code coter Bdd
AddEventHandler('esx_pj:weaponlicense', function(playerId)
local xPlayer = ESX.GetPlayerFromId(playerId) --Variable playerId sert a trouver Id du joueur proche.
local sourceXPlayer = ESX.GetPlayerFromId(source)
